...
/**
 * "Continue with Google" — only render when parent has confirmed `google` via /api/meta/auth-features.
 */
export const GoogleSignInBlock: React.FC<Props> = ({ onClick, loading }) => (
  <>
